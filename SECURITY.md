...
The following table shows which versions of `project_to_markdown` are currently being supported with security updates.
...
We deeply appreciate the efforts of security researchers and contributors who help us improve the security of `project_to_markdown`.
